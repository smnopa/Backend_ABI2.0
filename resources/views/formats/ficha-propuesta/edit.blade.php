                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="objetivo_especifico_2"
                                      ...
                                      placeholder="Describa el segundo objetivo específico (opcional)">{{ old('objetivo_especifico_2', $fichaPropuesta->objetivo_especifico_2) }}</textarea>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="objetivo_especifico_3"
                                      ...
                                      placeholder="Describa el tercer objetivo específico (opcional)">{{ old('objetivo_especifico_3', $fichaPropuesta->objetivo_especifico_3) }}</textarea>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="ods_objetivos_desarrollo_sostenible"
                                      ...
                                      placeholder="Seleccione del recurso disponible: https://www.un.org/sustainabledevelopment/es/objetivos-de-desarrollo-sostenible/">{{ old('ods_objetivos_desarrollo_sostenible', $fichaPropuesta->ods_objetivos_desarrollo_sostenible) }}</textarea>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="plan_desarrollo_nacional_departamental_municipal"
                                      ...
                                      placeholder="Línea/propósitos del Plan de Desarrollo al que apunta el proyecto">{{ old('plan_desarrollo_nacional_departamental_municipal', $fichaPropuesta->plan_desarrollo_nacional_departamental_municipal) }}</textarea>
