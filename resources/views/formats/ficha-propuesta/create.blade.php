    ...
    <div class="container-xl">
        @if ($errors->any())
            <div class="alert alert-danger alert-dismissible" role="alert">
                <div class="d-flex">
                    <div>
                        <h4 class="alert-title">Error al guardar</h4>
        ...
        <form action="{{ route('formatos.ficha-propuesta.store') }}" method="POST">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label required">Cantidad de Estudiantes</label>
                            <input type="number"
                                   name="cantidad_estudiantes"
                                   class="form-control @error('cantidad_estudiantes') is-invalid @enderror"
                                   value="{{ old('cantidad_estudiantes') }}"
                                   min="1"
                                   required>
                        ...
                        <div class="col-md-6">
                            <label class="form-label required">Tiempo de Ejecución (meses)</label>
                            <input type="number"
                                   name="tiempo_ejecucion_meses"
                                   class="form-control @error('tiempo_ejecucion_meses') is-invalid @enderror"
                                   value="{{ old('tiempo_ejecucion_meses') }}"
                                   min="1"
                                   required>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label required">Tipo de Investigación</label>
                            <select name="tipo_investigacion"
                                    class="form-select @error('tipo_investigacion') is-invalid @enderror"
                                    required>
                                <option value="">Seleccione un tipo...</option>
                                <option value="documental" {{ old('tipo_investigacion') == 'documental' ? 'selected' : '' }}>Documental</option>
                                <option value="experimental" {{ old('tipo_investigacion') == 'experimental' ? 'selected' : '' }}>Experimental</option>
                                <option value="campo" {{ old('tipo_investigacion') == 'campo' ? 'selected' : '' }}>De Campo</option>
                            </select>
                            ...
                            <select name="linea_investigacion_id"
                                ...
                                @foreach ($lineas as $linea)
                                    <option value="{{ $linea->id }}"
                                            {{ old('linea_investigacion_id') == $linea->id ? 'selected' : '' }}>
                                        {{ $linea->name }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <select name="area_tematica_id"
                                ...
                                @foreach ($areas as $area)
                                    <option value="{{ $area->id }}"
                                            {{ old('area_tematica_id') == $area->id ? 'selected' : '' }}>
                                        {{ $area->name }}
                                    </option>
                                @endforeach
                            </select>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-12">
                            <label class="form-label required">Objetivo General Tentativo</label>
                            <textarea name="objetivo_general"
                                      ...
                                      required>{{ old('objetivo_general') }}</textarea>
                        ...
                        <div class="col-12">
                            <label class="form-label required">Objetivo Específico 1</label>
                            <textarea name="objetivo_especifico_1"
                                      ...
                                      required>{{ old('objetivo_especifico_1') }}</textarea>
                        ...
                        <div class="col-12">
                            <label class="form-label">Objetivo Específico 2</label>
                            <textarea name="objetivo_especifico_2"
                                      rows="3"
                                      class="form-control @error('objetivo_especifico_2') is-invalid @enderror"
                                      placeholder="Describa el segundo objetivo específico (opcional)">{{ old('objetivo_especifico_2') }}</textarea>
                        ...
                        <div class="col-12">
                            <label class="form-label">Objetivo Específico 3</label>
                            <textarea name="objetivo_especifico_3"
                                      rows="3"
                                      class="form-control @error('objetivo_especifico_3') is-invalid @enderror"
                                      placeholder="Describa el tercer objetivo específico (opcional)">{{ old('objetivo_especifico_3') }}</textarea>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-12">
                            <label class="form-label required">Pertinencia con el Grupo de Investigación y Programa</label>
                            <textarea name="pertinencia_grupo_investigacion"
                                      ...
                                      required>{{ old('pertinencia_grupo_investigacion') }}</textarea>
                        ...
                        <div class="col-12">
                            <label class="form-label required">Disponibilidad de Docentes para Dirección y Calificación</label>
                            <textarea name="disponibilidad_docentes"
                                      ...
                                      required>{{ old('disponibilidad_docentes') }}</textarea>
                        ...
                        <div class="col-12">
                            <label class="form-label required">Calidad y Correspondencia entre Título y Objetivos</label>
                            <textarea name="calidad_correspondencia_titulo_objetivos"
                                      ...
                                      required>{{ old('calidad_correspondencia_titulo_objetivos') }}</textarea>
                        ...
                        <div class="col-12">
                            <label class="form-label required">Recursos Requeridos para el Desarrollo del Proyecto</label>
                            <textarea name="recursos_requeridos"
                                      ...
                                      required>{{ old('recursos_requeridos') }}</textarea>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-12">
                            <label class="form-label required">Descripción del Tema</label>
                        ...
                        <div class="col-12">
                            <label class="form-label">Objetivos de Desarrollo Sostenible (ODS)</label>
                            <textarea name="ods_objetivos_desarrollo_sostenible"
                                      ...
                                      placeholder="Seleccione del recurso disponible: https://www.un.org/sustainabledevelopment/es/objetivos-de-desarrollo-sostenible/">{{ old('ods_objetivos_desarrollo_sostenible') }}</textarea>
                        ...
                        <div class="col-12">
                            <label class="form-label">Plan de Desarrollo Nacional/Departamental/Municipal</label>
                            <textarea name="plan_desarrollo_nacional_departamental_municipal"
                                      ...
                                      placeholder="Línea/propósitos del Plan de Desarrollo al que apunta el proyecto">{{ old('plan_desarrollo_nacional_departamental_municipal') }}</textarea>
            ...
            <div class="card">
                <div class="card-footer text-end">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="ti ti-device-floppy me-1"></i> Crear Ficha
                    </button>
                </div>
            </div>
        </form>
