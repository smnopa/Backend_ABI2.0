...
<div class="page-header d-print-none">
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col">
                <h2 class="page-title">
                    Nueva Ficha de Propuesta de Tema
                </h2>
            </div>
        </div>
    </div>
        ...
        <form action="{{ route('formatos.ficha-propuesta.store') }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="objetivo_especifico_2"
                                      ...
                                      placeholder="Describa el segundo objetivo específico">{{ old('objetivo_especifico_2') }}</textarea>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="objetivo_especifico_3"
                                      ...
                                      placeholder="Describa el tercer objetivo específico">{{ old('objetivo_especifico_3') }}</textarea>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="ods_objetivos_desarrollo_sostenible"
                                      ...
                                      placeholder="ODS relacionados con el proyecto">{{ old('ods_objetivos_desarrollo_sostenible') }}</textarea>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="plan_desarrollo_nacional_departamental_municipal"
                                      ...
                                      placeholder="Línea o propósito del Plan de Desarrollo al que apunta el proyecto">{{ old('plan_desarrollo_nacional_departamental_municipal') }}</textarea>
            ...
            <div class="card">
                <div class="card-footer text-end">
                    <a href="{{ route('formatos.ficha-propuesta.index') }}" class="btn btn-secondary me-2">
                        Cancelar
                    </a>
